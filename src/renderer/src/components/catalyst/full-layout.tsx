...
export function FullLayout({
  ...
  return (
    <div className={clsx([
      ...
      'relative isolate flex h-screen w-full flex-col bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950',
    ])}
    >
      {/* Navbar */}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Content */}
        <main className="flex flex-1 flex-col pb-2 lg:min-w-0 lg:pr-2">
          <div className="size-full overflow-y-auto overflow-x-hidden p-4 lg:rounded-lg lg:bg-white lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
