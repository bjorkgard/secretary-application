...
export function Card2({ children, title, footer, loading = false }: CardProps): JSX.Element {
  return (
    <div className="card card-bordered col-span-2 bg-gray-50 shadow-xl dark:bg-slate-800">
      <div
