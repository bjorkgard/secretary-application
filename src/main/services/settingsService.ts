...
import { Settings, SettingsSchema } from '../databases/schemas'
import SettingsStore from '../databases/settingsStore'
import { SettingsService as ISettingsService } from '../../types/type'

const settingsStore = new SettingsStore('settings.db', SettingsSchema)

const parseSettingsModel = (data: SettingsModel): Settings => {
...
const parseSettings = (data: Settings): SettingsModel => {
